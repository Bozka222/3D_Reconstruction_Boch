...
while True:
    ...
    vertices.astype("float32").tofile(f"../dataset/new_3D_Up/second_try/vozidlo4/Raw_Depth{i}.raw")
    cv2.imwrite(f"../dataset/new_3D_Up/second_try/vozidlo4/Raw_Color{i}.jpg", blue_image)
    cv2.imwrite(f"../dataset/new_3D_Up/second_try/vozidlo4/Depth_Color_Image{i}.jpg", rotated_depth_colormap)
    cv2.imwrite(f"../dataset/new_3D_Up/second_try/vozidlo4/Stereo_Left_Image{i}.jpg", rotated_color_image)
    cv2.imwrite(f"../dataset/new_3D_Up/second_try/vozidlo4/Stereo_Right_Image{i}.jpg", rotated_RGB_image)
    key = cv2.waitKey(1)
...
with open(f"../dataset/new_3D_Up/second_try/vozidlo4/Metadata_3D.txt", "w") as metadata_file_1:
    metadata_file_1.write(json.dumps(metadata_3D))

with open(f"../dataset/new_3D_Up/second_try/vozidlo4/Metadata_RGB.txt", "w") as metadata_file_2:
    metadata_file_2.write(json.dumps(metadata_RGB))
